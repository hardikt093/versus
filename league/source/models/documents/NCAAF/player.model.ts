...
import { INflPlayerModel } from "../../interfaces/nflPlayer.interface";
...
var playerSchema = new Schema(
  {
    ...
    position: String,
    weight: String,
    isPassingPlayer: { type: Boolean, default: false },
    passing: {
    ...
    isRushingPlayer: { type: Boolean, default: false },
    rushing: {
      fumbles: String,
      fumbles_lost: String,
      longest_rush: String,
    ...
    isReceivingPlayer: { type: Boolean, default: false },
    receiving: {
      fumbles: String,
      fumbles_lost: String,
    ...
    isDefensePlayer: { type: Boolean, default: false },
    defence: {
    ...
    isScoringPlayer: { type: Boolean, default: false },
    scoring: {
      extra_points: String,
      field_goals: String,
      name: String,
    ...
    isKickingPlayer: { type: Boolean, default: false },
    kicking: {
    ...
    isPuntingPlayer: { type: Boolean, default: false },
    punting: {
...
const PlayersNCAAF = model<INflPlayerModel>("NcaafPlayers", playerSchema);

export default PlayersNCAAF;
