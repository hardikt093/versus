...
const envVarsSchema = Joi.object()
  .keys({
    ...
    CHAT_SERVER: Joi.string().required().description("Chat server"),
    LEAGUE_SERVER: Joi.string().required().description("League server"),
...
export default {
  ...
  port: envVars.PORT,
  chatServer: envVars.CHAT_SERVER,
  leagueServer: envVars.LEAGUE_SERVER,
  jwt: {
